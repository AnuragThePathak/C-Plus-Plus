...
int main()
{
    ifstream Reado("File Handling.txt"); // cin also a input stream. cin takes input from terminal/bash whereas objects of ifstream i.e. Reado in this case takes input from file 
    string str;
